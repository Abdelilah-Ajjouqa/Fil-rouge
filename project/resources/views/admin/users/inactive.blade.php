...
@section('content')
    <div class="max-w-7xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold">Inactive Users</h1>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex justify-between items-center mb-4">
                <div class="flex items-center">
                    ...
                    <h2 class="text-xl font-semibold">Inactive Users ({{ count($users) }})</h2>
                </div>
                <div class="relative">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <img class="h-10 w-10 rounded-full opacity-50"
                                                src="{{ $user->avatar ?? 'https://via.placeholder.com/40' }}"
                                                alt="{{ $user->username }}">
                                        </div>
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-500">{{ $user->first_name }}
                                                {{ $user->last_name }}</div>
