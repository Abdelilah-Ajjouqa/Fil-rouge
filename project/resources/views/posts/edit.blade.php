                            ...
                            <div class="mb-4">
                                ...
                                @if ($post->mediaContent->isNotEmpty())
                                    <div class="mb-4">
                                                ...
                                                <div class="relative">
                                                    @if (Str::startsWith($media->type, 'image/'))
                                                        <img src="{{ asset('storage/' . $media->path) }}"
                                                            alt="Current image" class="h-40 w-full object-cover rounded">
                                                    @elseif(Str::startsWith($media->type, 'video/'))
                                                        <div class="relative">
                                                            <video src="{{ asset('storage/' . $media->path) }}"
                                                                class="h-40 w-full object-cover rounded" muted>
                                                            </video>
                                                            <div class="absolute inset-0 flex items-center justify-center">
                                                                <i
                                                                    class="fas fa-play-circle text-white text-3xl opacity-80"></i>
                                                            </div>
                                                            <div
                                        ...
                                        <p class="text-gray-600 text-sm mt-2">{{ $post->mediaContent->count() }} file(s)
                                ...
                                <label for="media" class="block text-gray-700 font-medium mb-2">Upload New Media
                                    (Optional)</label>
                                <div class="border-2 border-gray-300 rounded-lg p-6 text-center"
                                    ...
                                    <div id="upload-prompt">
                                        ...
                                        <p class="text-gray-400 text-sm mt-1">Uploading new files will replace all current
                                            media</p>
                                        <p class="text-gray-400 text-sm mt-1">Recommendation: Use high-quality .jpg files or
                                            .mp4 videos less than 20MB</p>
                                    </div>
                        ...
                        if (file.type.startsWith('image/')) {
                            ...
                            reader.onload = function(e) {
                                ...
                                videoLabel.className =
                                    'absolute bottom-0 left-0 right-0 bg-black bg-opacity-50 text-white text-xs p-1 text-center';
